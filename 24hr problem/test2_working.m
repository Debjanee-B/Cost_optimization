...
for t = 1:1:N
     if (Pinflex(t) + Pflex(t)+ Pshift - Ppv(t)) > 0
        ...
        if (t >= 10) && (t <=14)
                [Pgrid(t), Pbatt(t), soc(t+1), fval] = hr1_working(Ppv(t), Pev(t), Pinflex(t), Pflex(t) + Pshift, soc(t), Cgrid(t));
                count = count + 1;
                total_cost = total_cost + fval;
                Pshift = 0;
        else
            
                [Pgrid(t), Pbatt(t), soc(t+1), fval] = hr1_working(Ppv(t), Pev(t), Pinflex(t),  0 , soc(t), Cgrid(t));
                total_cost = total_cost + fval;
