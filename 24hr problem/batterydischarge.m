function [Pgrid, Pbatt, cost, Pload] = batterydischarge(Ppv, Pev, Pinflex, Pflex, Cgrid, Pbatt_ulim, Pbatt_llim)
N = 24;
...
Pbatt1 = optimvar('Pbatt1', 'Type', 'continuous', 'Lowerbound', Pbatt_llim,'Upperbound', Pbatt_ulim);
